...
gcc -g -fno-pie mmap_intercept.c -rdynamic -fpic -shared -o mmap_intercept.so recorder.o actuator.o -lunwind -lpthread -lrt -lnuma -lsyscall_intercept -DINIT_ALLOC=2;
